 ...
 * @date 2019/1/22
 **/
public class PenguinMapperMethod {
    private final SqlCommand command;
    private final MethodSignature method;

    public PenguinMapperMethod(Class<?> mapperInterface, Method method, Configuration config) {
    ...
    private <E> Object executeForMany(SqlSession sqlSession, Object[] args) {
        ...
        if (!method.getReturnType().isAssignableFrom(result.getClass())) {
            ...
            } else if (PageModel.class.isAssignableFrom(method.getReturnType())) {
                Pager pager = null;
                for (Object arg : args) {
