 ...
 * @date 2019/1/28
 **/
public class PenguinSqlSessionFactoryBean extends SqlSessionFactoryBean {
    ...
    private SqlSessionFactoryBuilder sqlSessionFactoryBuilder = new PenguinSqlSessionFactoryBuilder();
    ...
    protected SqlSessionFactory buildSqlSessionFactory() throws IOException {
        ...
        PenguinXMLConfigBuilder xmlConfigBuilder = null;
        if (this.configuration != null) {
            ...
            xmlConfigBuilder = new PenguinXMLConfigBuilder(this.configLocation.getInputStream(), null, this.configurationProperties);
            targetConfiguration = xmlConfigBuilder.getConfiguration();
        } else {
            LOGGER.debug(() -> "Property 'configuration' or 'configLocation' not specified, using default MyBatis Configuration");
            targetConfiguration = new PenguinConfiguration();
