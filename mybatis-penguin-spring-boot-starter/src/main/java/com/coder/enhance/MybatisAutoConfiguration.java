 ...
 * @date 2019/1/25
 **/
@ConditionalOnClass({SqlSessionFactory.class, PenguinSqlSessionFactoryBean.class})
...
//        this.configurationCustomizers = configurationCustomizersProvider.getIfAvailable();
    ...
    public SqlSessionFactory sqlSessionFactory(DataSource dataSource) throws Exception {
        SqlSessionFactoryBean factory = new PenguinSqlSessionFactoryBean();
        ...
        factory.setSqlSessionFactoryBuilder(new PenguinSqlSessionFactoryBuilder());
    ...
    private void applyConfiguration(SqlSessionFactoryBean factory) {
        ...
        if (configuration == null && !StringUtils.hasText(this.properties.getConfigLocation())) {
            configuration = new PenguinConfiguration();
        }
